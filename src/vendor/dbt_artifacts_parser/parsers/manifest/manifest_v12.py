...
class Metadata(BaseParserModel):
    ...
    quoting: Optional[Quoting] = Field(None, description="The quoting configuration for the project")
    run_started_at: Optional[str] = Field(None, description="Timestamp when the dbt run started")
...
class Config16(BaseParserModel):
    ...
    snapshot_meta_column_names: Optional[SnapshotMetaColumnNames] = Field(None, title="SnapshotMetaColumnNames")
...
class ManifestV12(BaseParserModel):
    ...
    metadata: Metadata = Field(..., description="Metadata about the manifest", title="ManifestMetadata")
    nodes: dict[str, Union[Nodes, Nodes1, Nodes2, Nodes3, Nodes4, Nodes5, Nodes6, Nodes7]] = Field(
        ..., description="The nodes defined in the dbt project and its dependencies"
    )
    sources: dict[str, Sources] = Field(..., description="The sources defined in the dbt project and its dependencies")
    macros: dict[str, Macros] = Field(..., description="The macros defined in the dbt project and its dependencies")
    docs: dict[str, Docs18] = Field(..., description="The docs defined in the dbt project and its dependencies")
    exposures: dict[str, Exposures] = Field(..., description="The exposures defined in the dbt project and its dependencies")
    metrics: dict[str, Metrics] = Field(..., description="The metrics defined in the dbt project and its dependencies")
    ...
    saved_queries: dict[str, SavedQueries] = Field(..., description="The saved queries defined in the dbt project")
    semantic_models: dict[str, SemanticModels] = Field(..., description="The semantic models defined in the dbt project")
    unit_tests: dict[str, UnitTests] = Field(..., description="The unit tests defined in the project")
    functions: Optional[dict[str, Any]] = Field(None, description="User-defined functions in the dbt project")
