...
def gen_table(insight: InsightResult, severity: Severity) -> Dict[Text, Text]:
    return {
        "name": insight.name,
        "type": insight.type,
...
def generate_model_insights_table(model_insights: Dict[Text, List[DBTModelInsightResponse]]):
    results = {}
