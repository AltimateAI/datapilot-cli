...
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import TEST_TYPE_TO_NODE_MAP
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import ExposureNode
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import MacroNode
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import ManifestNode
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import SeedNodeMap
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import SourceNode
from datapilot.core.platforms.dbt.wrappers.manifest.v9.schemas import TestNode
from datapilot.core.platforms.dbt.wrappers.manifest.wrapper import BaseManifestWrapper


class ManifestV9Wrapper(BaseManifestWrapper):
    def __init__(self, manifest: ManifestV9):
