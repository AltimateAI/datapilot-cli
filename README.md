...
To check the project health of your dbt project, use the following command format in your terminal or command prompt:

```shell
datapilot dbt project-health --manifest-path [path_to_manifest] --catalog-path [path_to_catalog]
```
